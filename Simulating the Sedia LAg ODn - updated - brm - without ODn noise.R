...
saveRDS(model_parameters, 'data/Exponential-brm - without ODn noise.rds')
...
jpeg('other_figures/simulated_plot - exponential - brm_withoutnoise.jpeg', units = "in", width = 9, height = 9, res = 300)
ggplot_plots
dev.off()
