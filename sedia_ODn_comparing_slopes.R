...
hist_plot3 <- hist(dat$sedia_diff, breaks = 30, freq = FALSE, ylab = '', xlab = 'Sedia LAg differences', main = '', col = 'black', cex.lab = 1.5, cex.axis = 1.5) # , main = paste("Mean slope link=identity_", threshold)
