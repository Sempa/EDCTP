...
<!-- This study is funded by the [EDCTP Career Developmen Fellowship](http://www.edctp.org/projects-2/edctp2-projects/career-development-fellowships-2019/), grant number:TMA2019CDF-2760 supported by the European Union -->
...
<!-- ![](03-Red_EDCTP.jpg){height='200'} -->
<!-- ![](EU-flag.jpg){height = '200'} -->
```{r, echo=FALSE, out.width="33%", fig.align = "left", fig.show='hold'}
